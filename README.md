...
✅ Step 2:git clone 
https://github.com/Ankita-Tode/BOOK-SCRAPPER-DATA-ENGINEERING.git Clone the Repository

Then go inside:
cd BOOK-SCRAPPER-DATA-ENGINEERING
...
Based on your project type (FastAPI):
